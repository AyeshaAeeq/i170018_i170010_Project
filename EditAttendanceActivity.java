...
public class EditAttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(EditAttendanceActivity.this, course + ", " + section+ ", " + date, Toast.LENGTH_LONG).show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(EditAttendanceActivity.this,CoursesActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EditAttendanceActivity.this,DateActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder
                        = new AlertDialog
                        .Builder(EditAttendanceActivity.this);
        ...
        adapter = new MyRecyclerViewAdapter(data, this,"editattendance");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==200 && resultCode==RESULT_OK){
            ...
            try {
                ...
                image = InputImage.fromBitmap((Bitmap) data.getExtras().get("data"), getRotationCompensation(getCameraId(),EditAttendanceActivity.this,getApplicationContext()));
                labeler.process(image)
                        .addOnSuccessListener(new OnSuccessListener<List<ImageLabel>>() {
                            ...
                            public void onSuccess(List<ImageLabel> labels) {
                                ...
                                // ...
                                Toast.makeText(EditAttendanceActivity.this, "Got results from mlkit!!!", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                // ...
                                Toast.makeText(EditAttendanceActivity.this, "Failed to get results from mlkit!!!", Toast.LENGTH_SHORT).show();
                            }
                        });
